...
const TitleImgGoogleCalendar = styled.svg`
    top: 20px;
    left: 20px;
    width: 130px;
    height: 130px;
...
const TitleImgNotion = styled.div`
    bottom: 20px;
    right: 20px;
    width: 140px;
    height: 140px;
...
const TitleImgCircle = styled.div<{ color: string }>`
    height: 260px;
    width: 260px;
    border: dashed 4px ${(props) => props.color};
    border-radius: 160px;
    box-sizing: border-box;
    transform: rotate(0deg);
...
const GoogleCalendarLogo = (
    <TitleImgGoogleCalendar xmlns="http://www.w3.org/2000/svg" viewBox="186 38 76 76">
