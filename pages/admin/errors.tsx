                        ...
                        (errors.length === 0 ? (
                            ...
                            errors.map((error) => (
                                <Table.Row key={error.id}>
                                    ...
                                    <Table.Data>{`${error.code}`}</Table.Data>
                                    <Table.Data>{error.description}</Table.Data>
                                    ...
                                    <Table.Data>{dayjs(error.createdAt).fromNow()}</Table.Data>
